...
def parse_args():
    ...
    # General arguments
    # parser.add_argument('-d', '--dataset', default='mpi3dhp', type=str, metavar='NAME', help='target dataset') # h36m or humaneva
    parser.add_argument('-d', '--dataset', default='h36m', type=str, metavar='NAME', help='target dataset') # h36m or humaneva
    # parser.add_argument('-k', '--keypoints', default='sh_pt_mpii', type=str, metavar='NAME', help='2D detections to use')
    ...
    # parser.add_argument('-r', '--resume', default="/home/user001/zhmchen/st3dhpe/checkpoint/2022-03-06/h36m_cpn_ft_h36m_dbb_transformer_slowfast_joint_f9f27_d64_32_l4/epoch_3.bin", type=str, metavar='FILENAME', help='checkpoint to resume (file name)')
    # parser.add_argument('-r', '--resume', default='/home/omnisky/data/everyOne/zhmchen/result/st3dhpe/checkpoint/2022-03-15/h36m_cpn_ft_h36m_dbb_Mix_f27_d256_l8_5e-4/epoch_2.bin', type=str, metavar='FILENAME', help='checkpoint to resume (file name)')
    parser.add_argument('-r', '--resume', default='/home/zhmchen/Workspace/st3dhpe/checkpoint/2022-03-15/h36m_cpn_ft_h36m_dbb_Mix_f27_d128_l8_5e-4/epoch_5.bin', type=str, metavar='FILENAME', help='checkpoint to resume (file name)')
    # parser.add_argument('-r', '--resume', default='', type=str, metavar='FILENAME', help='checkpoint to resume (file name)')
    # parser.add_argument('-r', '--resume', default='/home/zhmchen/Workspace/st3dhpe/checkpoint/2022-02-23/h36m_cpn_ft_h36m_dbb_transformer_baseline_f9f27/epoch_4.bin', type=str, metavar='FILENAME', help='checkpoint to resume (file name)')
    # parser.add_argument('-r', '--resume', default="G:\human-pose-estimation\st3dhpe\checkpoint\\2022-02-13\h36m_cpn_ft_h36m_dbb_st_slowfast_baseline\epoch_2.bin", type=str, metavar='FILENAME', help='checkpoint to resume (file name)')
    # parser.add_argument('--evaluate', default="/home/user001/zhmchen/st3dhpe/checkpoint/2022-03-06/h36m_cpn_ft_h36m_dbb_transformer_slowfast_joint_f9f27_d64_32_l4/best_epoch_2.bin", type=str, metavar='FILENAME', help='checkpoint to evaluate (file name)')
    ...
    parser.add_argument('-frame_slow', '--number-of-frames_slow', default='9', type=int, metavar='N',
                        help='how many frames used as input')
    parser.add_argument('-frame_fast', '--number-of-frames_fast', default='27', type=int, metavar='N',
                        help='how many frames used as input')
