...
class opts():
    ...
    def init(self):
        self.parser.add_argument('--model', type=str, default='gcn_trans')
        # self.parser.add_argument('--model', type=str, default='motion_mixer2')
        # self.parser.add_argument('--model', type=str, default='mlp_mixer')
        ...
        self.parser.add_argument('--gcn_dim', default=32, type=int)
        self.parser.add_argument('--gcn_layers', default=4, type=int)
        self.parser.add_argument('--gcn_head', default=4, type=int)
        self.parser.add_argument('--activation', default='gelu', type=str)
        ...
        self.parser.add_argument("--lambda_seq2frame", default=0.0, type=float, help="seq2frame loss")
    ...
    def parse(self):
        ...
        if self.opt.train:
            ...
            if self.opt.model.startswith('motion'):
                ...
                self.opt.checkpoint = ckpt_path + kp + '_' + logtime + self.opt.model + '_l' + '%d'%(self.opt.num_layers)+ \
                                  '_d' + '%d'%(self.opt.hid_dim) + '_f' +'%d'%(frames) + '_bs' + '%d'%(self.opt.batch_size)
